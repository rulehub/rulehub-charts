...
Workflow:
1. Generate baseline: `hack/gen/gen-snapshots.sh values.yaml snapshots/baseline`
2. Commit the `snapshots/baseline` directory.
3. In CI / PRs run `hack/tools/compare-snapshots.sh snapshots/baseline` to detect template changes.
